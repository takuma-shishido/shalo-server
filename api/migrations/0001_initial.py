# Generated by Django 5.1.5 on 2025-01-28 07:54
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bookmarksCards', models.ManyToManyField(blank=True, related_name='bookmarked_by', to='api.carddata')),
            ],
            options={
                'verbose_name': 'user',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('card', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='api.carddata')),
            ],
        ),
    ]
